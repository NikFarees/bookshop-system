...
class UsersRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Vendor Staff';
        ...
        return $table
                ...
                Action::make('create_staff')
                    ...
                    ->form([
                        ...
                        Select::make('role')
                            ->label('Role')
                            ->options([
                                'admin' => 'Administrator (Vendor Admin)',
                                'staff' => 'Staff Member (Vendor Staff)',
                            ])
                            ->required()
                            ->default('staff'),
                    ])
                    ->action(function (array $data) {
                        $roleMapping = [
                            'admin' => ['role_id' => 3, 'org_role' => 'admin'],
                            'staff' => ['role_id' => 4, 'org_role' => 'staff'],
                        ];
                        ...
                        Notification::make()
                            ...
                            ->body("{$user->name} has been created and linked to this vendor.")
                            ->success()
                            ->send();
                    }),
            ])
            ->recordActions([
                Action::make('remove')
                    ...
                    ->modalDescription('Are you sure you want to remove this staff member from the vendor?')
            ...
            ->emptyStateDescription('Create a new staff member to link them to this vendor.')
